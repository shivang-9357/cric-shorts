export const NAVBAR_OPTIONS = ["All", "Live", "Upcoming", "Completed"];
export const teams = [
  { code: "CSK", name: "Chennai Super Kings", logo: "/logos/csk.png" },
  ...
  { code: "GT", name: "Gujarat Titans", logo: "/logos/gt.png" },
  { code: "LSG", name: "Lucknow Super Giants", logo: "/logos/lsg.png" },
];
export const venues = [
  "Mumbai",
  "Chennai",
